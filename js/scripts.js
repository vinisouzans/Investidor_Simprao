...
$(function(){
    ...
    function pegarValoresGrafico(cod){
      $.ajax({
          url:"https://brapi.dev/api/quote/" + cod + "?range=1mo&interval=1d&token=jSnQCacKDdHLjEyjwkarg5",
          type: "GET",
          dataType: "json",
    ...
    function pegarNoticiasIBGE2 (){
        $.ajax({               
            url: "https://servicodados.ibge.gov.br/api/v3/noticias/?qtd=9",
            type: "GET",
            dataType: "json",
            success: function(data){                
    ...
    $("#news-menu-id").click(function(){
        console.log("clicou no menu");
        pegarNoticiasIBGE2();
    });
       

    let test = $("#texto_cod_empresa").html();
